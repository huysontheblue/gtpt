                            ...
                            <div class="motel flex">
                                <a href="viewmotel.php?id=<?php echo $row["id"]; ?>">
                                    <div class="motel_left">
                                        <img src="<?php echo $row["images"]; ?>" alt="" srcset="" width ='150' height='150'>
                                    </div>
                                    <div class="motel_center">
                                        <h1 class='motel_center_title'><a href="viewmotel.php?id=<?php echo $row["id"]; ?>"> <?php echo $row["title"]; ?></a></h1>
                                        <?php
                                        ...
                                        <p class='motel_center_info price'><i class="fas fa-money-bill-alt"></i> Giá thuê: <span class="sprice"> <?php echo $row["price"]; ?></span></p>
                                    </div>
                                    <div class="motel_right">
                                        <p class='motel_right_info time'><i class="fal fa-clock"></i> Đăng <?php echo $timepost; ?></p>
